        ...
        implements CommandLineRunner
{
            ...
            Exception
    {
        ...
        a3 = authorService.addAuthor(a3);
        a4 = authorService.addAuthor(a4);
        a5 = authorService.addAuthor(a5);
        a6 = authorService.addAuthor(a6);
        ...
        s1 = sectionService.createNewSection(s1);
        s2 = sectionService.createNewSection(s2);
        s3 = sectionService.createNewSection(s3);
        s4 = sectionService.createNewSection(s4);
        s5 = sectionService.createNewSection(s5);

        List<Wrote> wrote = new ArrayList<>();
        wrote.add(new Wrote(a6, new Book()));
        Book b1 = new Book("Flatterland", "9780738206752", 2001, s1);
        b1.setWrotes(wrote);
        b1 = bookService.createNew(b1);

        wrote = new ArrayList<>();
        wrote.add(new Wrote(a2, new Book()));
        Book b2 = new Book("Digital Fortess", "9788489367012", 2007, s1);
        b2.setWrotes(wrote);
        b2 = bookService.createNew(b2);

        wrote = new ArrayList<>();
        wrote.add(new Wrote(a2, new Book()));
        Book b3 = new Book("The Da Vinci Code", "9780307474278", 2009, s1);
        b3.setWrotes(wrote);
        b3 = bookService.createNew(b3);
        ...
        b4.setWrotes(wrote);
        b4 = bookService.createNew(b4);

        wrote = new ArrayList<>();
        wrote.add(new Wrote(a4, new Book()));
        Book b5 = new Book("Calling Texas Home", "1885171382134", 2000, s3);
        b5.setWrotes(wrote);
        b5 = bookService.createNew(b5);
    }
}